...
namespace ISAC017.api.Controllers
{
    ...
    public class ISAC017001Controller : ControllerBase
    {
        ...
        public ISAC017001Controller(IManejadorRequest<APISAC017001MessageRequest> _manejadorRequest, IManejadorResponse<APISAC017001MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APISAC017001MessageResponse>> APISAC017001(APISAC017001MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APISAC017001", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APISAC017001", ex.ToString());
