...
namespace ICAJ024.api.Controllers
{
    ...
    public class ICAJ024001Controller : ControllerBase
    {
        ...
        public ICAJ024001Controller(IManejadorRequest<APICAJ024001MessageRequest> _manejadorRequest, IManejadorResponse<APILOG002001MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
       ...
       [Route("APICAJ024001")]
        public async Task<ActionResult<APILOG002001MessageResponse>> APICAJ024001(APICAJ024001MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APICAJ024001", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APICAJ024001", ex.ToString());
