...
namespace ICRE001.api.Controllers
{
    ...
    public class ICRE001001Controller : ControllerBase
    {
        ...
        public ICRE001001Controller(IManejadorRequest<APICRE001001MessageRequest> _manejadorRequest, IManejadorResponse<APICRE001001MessageResponse> _manejadorReponse)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<APICRE001001MessageResponse>> ICRE001001(APICRE001001MessageRequest parametrorequest)
        {
            try
            {
