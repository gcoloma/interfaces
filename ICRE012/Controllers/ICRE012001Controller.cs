...
using ICRE012.api.Models.Homologacion;
using ICRE012.Infraestructure.Configuration;
...
namespace ICRE012.api.Controllers
{
    ...
    public class ICRE012001Controller : ControllerBase
    {
        ...
        public ICRE012001Controller(IManejadorRequest<APICRE012001MessageRequest> _manejadorRequest, IManejadorResponse<APICRE012001MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APICRE012001MessageResponse>> APICRE012001(APICRE012001MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APICRE012001", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APICRE012001", ex.ToString());
