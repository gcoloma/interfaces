...
namespace ICAJ012.api.Controllers
{
    ...
    public class ICAJ012001Controller : ControllerBase
    {
        ...
        public ICAJ012001Controller(IManejadorRequest<APICAJ012001MessageRequest> _manejadorRequest, IManejadorResponse<APICAJ012001MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APICAJ012001MessageResponse>> APICAJ012001(APICAJ012001MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APICAJ012001", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APICAJ012001", ex.ToString());
