...
namespace ICAJ012.api.Controllers
{
    ...
    public class ICAJ012002Controller : ControllerBase
    {
        ...
        public ICAJ012002Controller(IManejadorRequest<APICAJ012002MessageRequest> _manejadorRequest, IManejadorResponse<APICAJ012002MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APICAJ012002MessageResponse>> APICAJ012002(APICAJ012002MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APICAJ012002", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APICAJ012002", ex.ToString());
