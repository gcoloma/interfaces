...
using ICRE008.api.Infrastructure.Configuration;
...
namespace ICRE008.api.Controllers
{
    ...
    [ApiController]
    public class ICRE008001Controller : ControllerBase
    {
        //PROPIEDADES DE COLAS
        private IManejadorRequest<APICRE008001MessageRequest> QueueRequest;
        private IManejadorResponse<APICRE008001MessageResponse> QueueResponse;
        ...
        public ICRE008001Controller(IManejadorRequest<APICRE008001MessageRequest> _manejadorRequest, IManejadorResponse<APICRE008001MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        [HttpPost]
        [Route("APICRE008001")]
        public async Task<ActionResult<APICRE008001MessageResponse>> APICRE008001(APICRE008001MessageRequest parametrorequest)
        {
            try
            {
                ...
                APICRE008001MessageResponse respuesta = null;
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APICRE008001", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APICRE008001", ex.ToString());
