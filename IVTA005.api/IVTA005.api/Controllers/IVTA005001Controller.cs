...
using IVTA005.api.Infrastructure.Configuration;
...
namespace IVTA005.api.Controllers
{
    ...
    public class IVTA005001Controller : ControllerBase
    {
        ...
        private IManejadorRequest<APIVTA005001MessageRequest> QueueRequest;
        private IManejadorResponse<APIVTA005001MessageResponse> QueueResponse;
        ...
        public IVTA005001Controller(IManejadorRequest<APIVTA005001MessageRequest> _manejadorRequest, IManejadorResponse<APIVTA005001MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APIVTA005001MessageResponse>> APIVTA005001(APIVTA005001MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APIVTA005001", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APIVTA005001", ex.ToString());
