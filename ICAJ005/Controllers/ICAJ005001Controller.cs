...
using ICAJ005.api.Infrastructure.Configuration;
using ICAJ005.api.Infrastructure.Services;
using ICAJ005.api.Models._001.Request;
using ICAJ005.api.Models._001.Response;
using ICAJ005.api.Models.Homologacion;
...
namespace ICAJ005.api.Controllers
{
    ...
    public class ICAJ005001Controller : ControllerBase
    {
        ...
        public ICAJ005001Controller(IManejadorRequest<APICAJ005001MessageRequest> _manejadorRequest, IManejadorResponse<APICAJ005001MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APICAJ005001MessageResponse>> APICAJ005001(APICAJ005001MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APICAJ005001", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APICAJ005001", ex.ToString());
