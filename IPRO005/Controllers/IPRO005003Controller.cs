...
namespace IPRO005.api.Controllers
{
    ...
    public class IPRO005003Controller : ControllerBase
    {
        ...
        public IPRO005003Controller(IManejadorRequest<APIPRO005003MessageRequest> _manejadorRequest, IManejadorResponse<APIPRO005003MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APIPRO005003MessageResponse>> APIPRO005003(APIPRO005003MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APIPRO005003", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APIPRO005003", ex.ToString());
