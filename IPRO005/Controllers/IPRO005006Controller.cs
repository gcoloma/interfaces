...
namespace IPRO005.api.Controllers
{
    ...
    public class IPRO005006Controller : ControllerBase
    {
        ...
        public IPRO005006Controller(IManejadorRequest<APIPRO005006MessageRequest> _manejadorRequest, IManejadorResponse<APIPRO005006MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APIPRO005006MessageResponse>> APIPRO005006(APIPRO005006MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APIPRO005006", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APIPRO005006", ex.ToString());
