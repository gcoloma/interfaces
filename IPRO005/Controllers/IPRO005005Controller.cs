...
namespace IPRO005.api.Controllers
{
    ...
    public class IPRO005005Controller : ControllerBase
    {
        ...
        public IPRO005005Controller(IManejadorRequest<APIPRO005005MessageRequest> _manejadorRequest, IManejadorResponse<APIPRO005005MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APIPRO005005MessageResponse>> APIPRO005005(APIPRO005005MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APIPRO005005", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APIPRO005005", ex.ToString());
