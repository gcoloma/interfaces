...
namespace IPRO005.api.Controllers
{
    ...
    public class IPRO005002Controller : ControllerBase
    {
        ...
        public IPRO005002Controller(IManejadorRequest<APIPRO005002MessageRequest> _manejadorRequest, IManejadorResponse<APIPRO005002MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APIPRO005002MessageResponse>> APIPRO005002(APIPRO005002MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APIPRO005002", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APIPRO005002", ex.ToString());
