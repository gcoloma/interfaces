...
namespace IPRO005.api.Controllers
{
    ...
    public class IPRO005007Controller : ControllerBase
    {
        ...
        public IPRO005007Controller(IManejadorRequest<APIPRO005007MessageRequest> _manejadorRequest, IManejadorResponse<APIPRO005007MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APIPRO005007MessageResponse>> APIPRO005007(APIPRO005007MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APIPRO005007", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APIPRO005007", ex.ToString());
