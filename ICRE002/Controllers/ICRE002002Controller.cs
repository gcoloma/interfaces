...
namespace ICRE002.api.Controllers
{
    ...
    public class ICRE002002Controller : ControllerBase
    {
        ...
        public ICRE002002Controller(IManejadorRequest<APICRE002002MessageRequest> _manejadorRequest, IManejadorResponse<APICRE002002MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APICRE002002MessageResponse>> APICRE002002(APICRE002002MessageRequest parametrorequest)
        {
            ...
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APICRE002002", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APICRE002002", ex.ToString());
