    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
                      ...
                      services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "ICAJ008.api",
                    Description = "CAJ-012 Interfaz con SIAC Caja para generar desde el MSD365FO el proceso de facturación al momento de la venta.CAJ - 013.Desarrollo de Facturación luego del Despacho:",
                    Version = "v1"
                });
            });
        }
