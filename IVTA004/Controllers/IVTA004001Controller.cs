...
using IVTA004.api.Infrastructure.Configuration;
using IVTA004.api.Infrastructure.Services;
using IVTA004.api.Models._001.Request;
using IVTA004.api.Models._001.Response;
using IVTA004.api.Models.Homologacion;
...
namespace IVTA004.api.Controllers
{
    ...
    public class IVTA004001Controller : ControllerBase
    {
        ...
        public IVTA004001Controller(IManejadorRequest<APISAC020001MessageRequest> _manejadorRequest, IManejadorResponse<APIVTA004001MessageResponse> _manejadorReponse, IHomologacionService<ResponseHomologa> _homologacionRequest)
        {
        ...
        public async Task<ActionResult<APIVTA004001MessageResponse>> APIVTA004001(APISAC020001MessageRequest parametrorequest)
        {
            try
            {
                ...
                if (respuesta == null)
                {
                    Logger.FileLogger("APIVTA004001", "No se retorno resultado de Dynamics");
            ...
            {
                Logger.FileLogger("APIVTA004001", ex.ToString());
